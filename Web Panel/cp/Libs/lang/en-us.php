...
define('setting_multiserver_ip_lang','Set the server IP');
define('setting_multiserver_uname_lang','Set the username of the server');
define('setting_multiserver_pass_lang','Set the server password');
