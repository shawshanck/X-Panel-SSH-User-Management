...
// تولید و بررسی توکن CSRF
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST' and $link_s != 'api') {
            ...
            if (validateCsrfToken($submittedToken)) {
                ...
                require_once("../app/Models/Limit_Model.php");
...
// نمایش توکن CSRF در فرم
        ...
        if($url!='reinstall')
        {
            require_once("../app/Models/Ban_Model.php");
        ...
        if ($urlex[0] == 'assets') {
            ...
            if (!file_exists("../app/Controllers/" . ucfirst($url[0]) . ".php")) {
                ...
                require_once("../app/Libs/lang/" . LANG . ".php");
                require_once("../app/Libs/jdf.php");
                require_once("../app/Models/Permission_Model.php");
