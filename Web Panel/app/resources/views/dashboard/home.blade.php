                            ...
                            <div class="row">
                                <div class="col-lg-12 col-xl-12">
                                    <ul class="list-group list-group-flush">
                                        @foreach ($user_band as $val)

                                        @if (1024 < $val->total)
                                            @php $to = round($val->total / 1024, 2) .' GB'; @endphp
                                         @else
                                            @php $to = $val->total .' MB'; @endphp
                                            @endif
                                    ...
                                    <li class="list-group-item">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-grow-1 ms-3">
                                                <div class="row g-1">
                                                    <div class="col-6">
                                                        <p class="text-muted mb-1">{{$val->username}}</p>
                                                        <h6 class="mb-0">Expiration: {{$val->end_date}}</h6>
                                                    </div>
